...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen  text-gray-900">
      ...
      <form className="flex flex-col items-center w-full max-w-sm  p-8 border border-zinc-600 rounded-lg shadow-xl space-y-6"
      ...
      <p className="mt-8 text-gray-900">New user? Register here</p>
      <Link className="underline hover:text-blue-400" to="/register">Register</Link>     
   </div>
  );
};
